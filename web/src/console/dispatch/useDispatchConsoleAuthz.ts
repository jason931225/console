...
/**
 * Dispatch's route adapter consumes the console's canonical parsed authz
 * projection (same shape as the production module). It fails closed to the
 * canonical JWT floor while the authoritative projection loads.
 */
export function useDispatchConsoleAuthz() {
