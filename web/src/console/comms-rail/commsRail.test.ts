...
const notification = { items: [{ id: ID, recipient_user_id: ID_TWO, category: "approval", kind: "assigned", text: "x", link: { type: "screen", screen: "overview" }, unread: true, created_at: NOW, read_at: null, resolved_at: null, muted: false }] };
