...
const postgresDomainReachabilityCommands = [
  ...
  "//tools/buck:ontology-property-policy-enforcement-postgres \\",
...
const postgresWrapperContracts = [
  ...
  ["ontology-property-policy-enforcement-postgres", "//backend/crates/ontology/rest:console-ontology-rest-itest-property_policy_enforcement_as_runtime_role"],
