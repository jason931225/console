...
// Cross-package reference. A package-relative `test = "run_test_with_postgres_env.sh"`
// resolves inside //tools/buck; once the loader moved to //tools/pg, buck2 could no
// longer parse the package at all. The wrappers now name an export_file target.
const postgresWrapperLoader = "//tools/pg:run_test_with_postgres_env.sh";
