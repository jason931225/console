...
const postgresDomainReachabilityCommands = [
  ...
  "//tools/buck:app-benefit-catalog-api-pg \\",
  ...
  "//tools/buck:app-compliance-catalog-api-pg \\",
  "//tools/buck:app-console-kill-switch-pg \\",
  "//tools/buck:app-console-route-telemetry-pg \\",
  "//tools/buck:app-consulting-engagement-api-pg \\",
  ...
  "//tools/buck:app-facilities-pilot-story-pg \\",
  ...
  "//tools/buck:app-logistics-pilot-story-pg \\",
  ...
  "//tools/buck:identity-rest-org-setup-pg \\",
  ...
  "//tools/buck:production-rest-production-lifecycle-http-pg \\",
...
const postgresWrapperContracts = [
  ...
  ["app-benefit-catalog-api-pg", "//backend/app:console-app-itest-benefit_catalog_api"],
  ...
  ["app-compliance-catalog-api-pg", "//backend/app:console-app-itest-compliance_catalog_api"],
  ...
  ["app-consulting-engagement-api-pg", "//backend/app:console-app-itest-consulting_engagement_api"],
  ...
  ["app-facilities-pilot-story-pg", "//backend/app:console-app-itest-facilities_pilot_story"],
  ...
  ["app-logistics-pilot-story-pg", "//backend/app:console-app-itest-logistics_pilot_story"],
  ...
  ["identity-rest-org-setup-pg", "//backend/crates/identity/rest:console-identity-rest-itest-org_setup"],
  ...
  ["production-rest-production-lifecycle-http-pg", "//backend/crates/production/rest:console-production-rest-itest-production_lifecycle_http"],
