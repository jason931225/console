...
| [ADR-0041](ADR-0041-layer-ui-accepted.md) | accepted | Accepts `Layer::Ui` (`allowed_deps` `[Contracts, Ui]`; App gains Ui), classifies `-ui` before `crates/platform/`, enforces Ui edges, and opens the Leptos implementation gate for the payroll vertical; amends ADR-0001 and ADR-0030 |
