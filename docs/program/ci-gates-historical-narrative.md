> **HISTORICAL ESSAY — NOT THE LIVE INVENTORY.**
> Live machine-checked inventory: [`docs/CI-GATES.md`](../CI-GATES.md).
> This page was split from that file on 2026-08-17. Present-tense sentences may describe deleted surfaces (`web/`, `android/`, `e2e/`) or retired jobs. Do not dispatch work or treat this essay as current CI.

# Historical CI gate essay
